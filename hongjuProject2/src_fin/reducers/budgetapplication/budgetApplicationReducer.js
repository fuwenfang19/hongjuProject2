...
const $$initialState = Immutable.fromJS({
	// 我的预算社情查询条件
	myBudgetApplicationSearchConditions: {
		codes: [],
		objectclassids: [],
		braidDateBegin: null,
		braidDateEnd: null,
		...
		amountEnd: null,
		remarks: '',
		listtype: 'application',//application adjustment
		pagenum: 1,
		countperpage: 50,
	},
	// 我的预算申请列表数据
	budgetApplicationList: {total: 0, rows: []},
	// 所有的预算申请单类型列表
	budgetBillTypes: [],
...
export default function budgetApplicationReducer($$state = $$initialState, action = {}) {
	switch (action.type) {
		case types.CHANGE_BUDGET_APPLICATION_KEY_VALUE:
