...
class TreeNode extends Component {
    ...
    render() {
        ...
        //处理TreeNode节点被选中和被点击
        let self = this;
        function cb(p, e, handleSelect) {
            if (typeof handleSelect === 'function') {
                handleSelect.call(self, self.props.info, self.props.item, p, self.props.company);
            }
        }
        ...
        return (
            <li className="lazy-tree-node" ref='li'>
                ...
                <span ref="span" className={this.props.hasChildren ? this.state.switchClassName : "state-tree-switch tree-switch no-childe-span" } onClick={(p, e) => {
                    this.switchClick();
