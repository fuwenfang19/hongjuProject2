/**
 * Created by fuwenfang on 3/17/17.
 * 费用类型编辑拖拽
 */
...
export default class Card extends Component {
  ...
  changeDisp = (e, index) => {
    ...
    const { defaultBillingSetting } = this.props
    ...
    this.props.changeCheckedSettingItem(newbillSettingInfor)
  }
  ...
  render() {
    const { item, index, connectDragSource, connectDropTarget, handleChangeCheckbox, deletSettingItem } = this.props
